...
import { IncomeSource, useFindOneQuery, useUpdateTaxReturnMutation } from "../../../app/api/taxApi";
import { useSelector } from "react-redux/es/hooks/useSelector";
import { selectUserEmail } from "../../../app/features/userSlice";

export default function FormW2({ onClose }: { onClose: () => void }) {
    ...
    return (
        <>
            <Form onSubmit={handleSubmit}>
                <Fieldset legend={"W2 " + t("taxIncomePage.form")} legendStyle="large" style={{ minWidth: "25vw" }}>
                    ...
                    <div>
                        <Label htmlFor="stateWithheld">{t("taxIncomePage.stateTaxWithheld")}{' '}
                        <abbr title="required" className="usa-hint usa-hint--required">
                        *
                        </abbr></Label>
                        <span className="usa-hint">{t("taxIncomePage.inputValidNumber")}</span>
                    ...
                    <div>
                        <Label htmlFor="fedWithheld">{t("taxIncomePage.federalTaxWithheld")}{' '}
                        <abbr title="required" className="usa-hint usa-hint--required">
                        *
                        </abbr></Label>
                        <span className="usa-hint">{t("taxIncomePage.inputValidNumber")}</span>
